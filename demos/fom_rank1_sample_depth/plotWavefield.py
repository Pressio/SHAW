...
###############################
  ...
  fomFile1  = './state_timestep_8000_vp_d240'
  fomState1 = np.loadtxt(fomFile1, skiprows=1)
  doPlot(th, r, fomState1.reshape((nr, nth)), 0,[-5e-9, 5e-9], 
         "wavefield_8000_d240.png", title="sourceDepth = 240 Km")

  fomFile2  = './state_timestep_8000_vp_d700'
  fomState2 = np.loadtxt(fomFile2, skiprows=1)
  doPlot(th, r, fomState2.reshape((nr, nth)), 0,[-5e-9, 5e-9], 
         "wavefield_8000_d700.png", title="sourceDepth = 700 Km")
