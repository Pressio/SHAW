...
execute_process(COMMAND ${CMD_COMPARE} snaps_sp_0 snaps_sp_gold_0.txt 1e-10 RESULT_VARIABLE RES)
if(RES)
...
execute_process(COMMAND ${CMD_COMPARE} snaps_sp_1 snaps_sp_gold_1.txt 1e-10 RESULT_VARIABLE RES)
if(RES)
...
execute_process(COMMAND ${CMD_COMPARE} snaps_sp_2 snaps_sp_gold_2.txt 1e-10 RESULT_VARIABLE RES)
if(RES)
