...
int main(int argc, char *argv[])
{
  Kokkos::initialize (argc, argv);
  {
    ...
    vb.push_back(parser.getSourceProperty("depth") == 1100.);
    vb.push_back(parser.getSourceProperty("angle") == 88.);
    vb.push_back(parser.getSourceProperty("period") == 40.);
    vb.push_back(parser.getSourceProperty("delay") == 10.);

    // material
    vb.push_back(parser.getMaterialModelKind() == materialModelKind::bilayer);

    const auto a1 = parser.viewDiscontinuityDepthsKm();
    vb.push_back(a1.size()==2);
    vb.push_back(a1[0]==0.);
    vb.push_back(a1[1]==556.);

    const auto a2 = parser.viewDensityParametrization();
    vb.push_back(a2.size()==2);
    vb.push_back(a2[0].size()==3);
    vb.push_back(a2[0][0]==2000.);
    vb.push_back(a2[0][1]==0.);
    vb.push_back(a2[0][2]==50.);
    vb.push_back(a2[1].size()==3);
    vb.push_back(a2[1][0]==100.);
    vb.push_back(a2[1][1]==0.5);
    vb.push_back(a2[1][2]==23.);

    const auto a3 = parser.viewVelocityParametrization();
    vb.push_back(a3.size()==2);
    vb.push_back(a3[0].size()==3);
    vb.push_back(a3[0][0]==5000.);
    vb.push_back(a3[0][1]==10.);
    vb.push_back(a3[0][2]==44.);
    vb.push_back(a3[1].size()==3);
    vb.push_back(a3[1][0]==5000.);
    vb.push_back(a3[1][1]==0.);
    vb.push_back(a3[1][2]==0.);
